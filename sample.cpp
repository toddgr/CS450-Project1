...
const char *WINDOWTITLE = { "OpenGL / Project #1 - Grace Todd" };
...
void Display( )
{
	...
	glLoadIdentity( );
	glColor3f( 1., 1., 1. );
	DoRasterString( 5., 5., 0., (char *)"Project 1" );
...
void InitLists( )
{
	...
	TrianglesList = glGenLists(1);
	glNewList(TrianglesList, GL_COMPILE);
